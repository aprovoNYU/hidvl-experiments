...
df_pre_2019_dmd = pd.read_csv("/Users/alexandra/Desktop/hidvl-experiments/hidvl_dmd_parsed_combined_2019-11-22_05-09_PM-april2020_pre-2019.tsv",na_filter=False,sep='\t',quotechar = '"')

# print dataframe
# print(df_pre_2019_dmd)
# print(df_pre_2019_dmd.loc[2])
#df_pre_2019_dmd.loc[:,"Alternate Title 1"] = pd.Series["none"]
#print(df_post_2019_dmd)

#print(df_pre_2019_dmd.info())
#print(list(df_post_2019_dmd.columns.values))

#print(df_post_2019_dmd.columns.difference(df_pre_2019_dmd))
...
#df_pre_2019_dmd.reset_index()
#print(df_pre_2019_dmd["Additional_Production_Credits"][6])
...
df_post_2019_dmd = pd.read_csv("/Users/alexandra/Desktop/hidvl-experiments/Metadata-April 2020 publication cycle export.csv",na_filter=False,quotechar = '"')
...
df_combined_dmd.to_csv("hidvl_april2020_combined_%s.csv"%filetime, index=False)